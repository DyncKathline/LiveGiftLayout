package org.dync.giflibrary.widget;
...
public class GiftControl implements GiftFrameLayout.LeftGiftAnimationStatusListener {
    ...
    public void setGiftLayout(int index1, GiftFrameLayout giftFrameLayout1, int index2, GiftFrameLayout giftFrameLayout2) {
        mFirstItemGift = giftFrameLayout1;
        mSecondItemGift = giftFrameLayout2;

        mFirstItemGift.setIndex(index1);
        mSecondItemGift.setIndex(index2);
    ...
    private void addGiftQueue(GiftModel gift) {
        if (mGiftQueue != null) {
